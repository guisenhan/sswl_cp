...
public class ImageResizer extends ImageWorker {
	...
	@Override
	protected Bitmap processBitmapByPhoto(String filename, String thumbPath) {
		Bitmap bitmap = null;
		if (thumbPath != null && !"".equals(thumbPath)) {
			bitmap = decodeSampledBitmapFromFile(thumbPath, mImageWidth, mImageHeight);
		}
		if (bitmap == null) {
			bitmap = decodeSampledBitmapFromFile(filename, mImageWidth, mImageHeight);
		}
		return bitmap;
	}
